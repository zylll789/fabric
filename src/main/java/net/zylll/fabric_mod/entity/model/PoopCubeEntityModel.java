...
public class PoopCubeEntityModel extends EntityModel<PoopCube> {

    private final ModelPart base;

    public PoopCubeEntityModel(ModelPart modelPart){
    ...
    @Override
    public void setAngles(PoopCube entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
